...
<div class="container px-4 py-6 mx-auto">
    <div class="flex flex-col md:flex-row items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Edit Kapal</h1>
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-6">
        <div class="border-b border-gray-200 bg-gray-50 px-6 py-3">
            <h2 class="text-lg font-semibold text-blue-600">Form Edit Kapal</h2>
        </div>
        <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $ferry->name) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="registration_number" name="registration_number" value="{{ old('registration_number', $ferry->registration_number) }}" required
                                   class="w-full rounded-md border border-gray-300 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>

                        <div>
                            <label for="year_built" class="block text-sm font-medium text-gray-700 mb-1">Tahun Pembuatan</label>
                            <input type="number" id="year_built" name="year_built" value="{{ old('year_built', $ferry->year_built) }}" min="1900" max="{{ date('Y') }}"
                                   class="w-full rounded-md border border-gray-300 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>

                        <div>
                            <label for="last_maintenance_date" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Perawatan Terakhir</label>
                            <input type="date" id="last_maintenance_date" name="last_maintenance_date" value="{{ old('last_maintenance_date', $ferry->last_maintenance_date ? $ferry->last_maintenance_date->format('Y-m-d') : '') }}"
                                   class="w-full rounded-md border border-gray-300 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="number" id="capacity_passenger" name="capacity_passenger" value="{{ old('capacity_passenger', $ferry->capacity_passenger) }}" min="1" required
                                   class="w-full rounded-md border border-gray-300 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="capacity_vehicle_motorcycle" name="capacity_vehicle_motorcycle" value="{{ old('capacity_vehicle_motorcycle', $ferry->capacity_vehicle_motorcycle) }}" min="0" required
                                   class="w-full rounded-md border border-gray-300 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="capacity_vehicle_car" name="capacity_vehicle_car" value="{{ old('capacity_vehicle_car', $ferry->capacity_vehicle_car) }}" min="0" required
                                   class="w-full rounded-md border border-gray-300 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="capacity_vehicle_bus" name="capacity_vehicle_bus" value="{{ old('capacity_vehicle_bus', $ferry->capacity_vehicle_bus) }}" min="0" required
                                   class="w-full rounded-md border border-gray-300 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="capacity_vehicle_truck" name="capacity_vehicle_truck" value="{{ old('capacity_vehicle_truck', $ferry->capacity_vehicle_truck) }}" min="0" required
                                   class="w-full rounded-md border border-gray-300 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    @if($ferry->image)
                        ...
                        <div class="mb-3 flex items-center">
                            ...
                            <label for="remove_image" class="ml-2 block text-sm text-gray-700">Hapus foto saat ini</label>
                        </div>
                    @endif
                    ...
                    <p class="mt-1 text-xs text-gray-500">Unggah foto baru kapal (opsional). Ukuran maksimum 2MB. Format: JPG, PNG.</p>
                </div>

                <div class="mt-6">
                    <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Deskripsi</label>
                    <textarea id="description" name="description" rows="4"
                              class="w-full rounded-md border border-gray-300 shadow-sm px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('description', $ferry->description) }}</textarea>
                </div>
