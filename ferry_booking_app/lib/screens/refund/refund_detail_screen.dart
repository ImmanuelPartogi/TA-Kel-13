...
class _RefundDetailScreenState extends State<RefundDetailScreen> {
  ...
  Future<void> _loadRefundDetails() async {
    ...
    await refundProvider.getRefundDetailsByBookingId(widget.booking.id);
  }
  
  Future<void> _refreshRefundDetails() async {
    final refundProvider = Provider.of<RefundProvider>(context, listen: false);
    await refundProvider.refreshCurrentRefund();
  }
  ...
  Future<void> _cancelRefund() async {
    ...
    if (result) {
      ...
      final success = await refundProvider.cancelRefund(widget.refund.id);
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 4),
                                    Text(
                                      _getStatusDescription(refund.status),
                                      style: TextStyle(
                                        color: Colors.white.withOpacity(0.9),
                                        fontSize: 12,
                                      ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Divider(),
                              _buildInfoRow('Jumlah Refund', refund.formattedAmount),
                              const Divider(),
                              _buildInfoRow('Tanggal Permintaan', refund.formattedCreatedDate),
                              if (refund.transactionId != null) ...[
                                const Divider(),
                                _buildInfoRow('ID Transaksi', refund.transactionId!),
                              ],
                            ],
                          ),
                        ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Divider(),
                              _buildInfoRow('Nomor Rekening', refund.bankAccountNumber),
                              const Divider(),
                              _buildInfoRow('Nama Pemilik', refund.bankAccountName),
                            ],
                          ),
                        ),
                      ),
