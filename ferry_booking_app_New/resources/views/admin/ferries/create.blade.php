...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Kapal</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.ferries.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="year_built" name="year_built" value="{{ old('year_built') }}" min="1900" max="{{ date('Y') }}">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="capacity_passenger" name="capacity_passenger" value="{{ old('capacity_passenger', 0) }}" min="1" required>
                        </div>
                        <div class="mb-3">
                            <label for="capacity_vehicle_motorcycle" class="form-label">Kapasitas Motor <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="capacity_vehicle_motorcycle" name="capacity_vehicle_motorcycle" value="{{ old('capacity_vehicle_motorcycle', 0) }}" min="0" required>
                        </div>
                        <div class="mb-3">
                            <label for="capacity_vehicle_car" class="form-label">Kapasitas Mobil <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="capacity_vehicle_car" name="capacity_vehicle_car" value="{{ old('capacity_vehicle_car', 0) }}" min="0" required>
                        </div>
                        <div class="mb-3">
                            <label for="capacity_vehicle_bus" class="form-label">Kapasitas Bus <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="capacity_vehicle_bus" name="capacity_vehicle_bus" value="{{ old('capacity_vehicle_bus', 0) }}" min="0" required>
                        </div>
                        <div class="mb-3">
                            <label for="capacity_vehicle_truck" class="form-label">Kapasitas Truk <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="capacity_vehicle_truck" name="capacity_vehicle_truck" value="{{ old('capacity_vehicle_truck', 0) }}" min="0" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <small class="form-text text-muted">Unggah foto kapal (opsional). Ukuran maksimum 2MB. Format: JPG, PNG.</small>
                </div>
