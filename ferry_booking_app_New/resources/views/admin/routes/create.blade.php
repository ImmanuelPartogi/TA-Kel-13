...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Rute Baru</h1>
            ...
            <form action="{{ route('admin.routes.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control" id="distance" name="distance" value="{{ old('distance') }}" step="0.01" min="0">
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="base_price" name="base_price" value="{{ old('base_price', 0) }}" min="0" required>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control" id="motorcycle_price" name="motorcycle_price" value="{{ old('motorcycle_price', 0) }}" min="0" required>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control" id="car_price" name="car_price" value="{{ old('car_price', 0) }}" min="0" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control" id="bus_price" name="bus_price" value="{{ old('bus_price', 0) }}" min="0" required>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control" id="truck_price" name="truck_price" value="{{ old('truck_price', 0) }}" min="0" required>
                        </div>
                    </div>
                </div>
