                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="{{ route('operator.bookings.check-in') }}"
                                    class="btn btn-block btn-primary btn-lg mb-3">
                            ...
                            <div class="col-6">
                                <a href="{{ route('operator.bookings.index') }}"
                                    class="btn btn-block btn-info btn-lg mb-3">
                            ...
                            <div class="col-6">
                                <a href="{{ route('operator.schedules.index') }}"
                                    class="btn btn-block btn-success btn-lg mb-3">
                            ...
                            <div class="col-6">
                                <a href="{{ route('operator.reports.index') }}"
                                    class="btn btn-block btn-warning btn-lg mb-3">
                                    ...
                                    <li class="item">
                                        <div class="product-info">
                                            <a href="javascript:void(0)" class="product-title">
                                                ...
                                                @endphp
                                                <span
                                                    class="badge {{ $badgeClass }} float-right">{{ $activity->status }}</span>
                                            </a>
