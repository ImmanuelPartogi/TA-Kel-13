...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray-200 py-4 relative overflow-hidden">
      {/* Footer blob decoration */}
      <div className="absolute opacity-15 -right-24 -bottom-20">
        <svg className="animate-float-slow" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"
          style={{ width: "150px" }}>
          <path fill="#4470f4"
      ...
      <div className="absolute opacity-15 left-10 -bottom-10">
        <svg className="animate-bounce-slow" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"
          style={{ width: "120px" }}>
          <path fill="#81a8ff"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <div className="text-sm text-gray-500 mb-2 sm:mb-0">
            &copy; {new Date().getFullYear()} Ferry Ticket System. All rights reserved.
          </div>
