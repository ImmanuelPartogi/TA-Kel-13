  ...
  return (
    <header className="relative z-10 flex-shrink-0 h-16 bg-white shadow-sm overflow-hidden">
      ...
      <div className="absolute opacity-15 -right-16 -top-16">
        <svg className="animate-morph-slow" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" style={{ width: 180 }}>
          <path
            fill="#4470f4"
      ...
      <div className="absolute opacity-15 left-20 top-0">
        <svg className="animate-drift-right" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" style={{ width: 120 }}>
          <path
            fill="#3aa3ff"
