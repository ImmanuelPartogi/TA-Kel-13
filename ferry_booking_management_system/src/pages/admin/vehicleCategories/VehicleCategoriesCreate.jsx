...
const VehicleCategoriesCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Kirim data ke API menggunakan createCategory
      await AdminVehicleCategoriesService.createCategory(dataToSubmit);
      ...
      if (error.response && error.response.data && error.response.data.errors) {
        ...
        setNotification({
          show: true,
          message: 'Gagal menambahkan kategori kendaraan',
          type: 'error'
        });
      }
    } finally {
        ...
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="flex items-start">
              ...
              <div>
                <h1 className="text-3xl font-bold">Tambah Kategori Kendaraan</h1>
                <p className="mt-1 text-blue-100">Buat kategori kendaraan baru untuk sistem tiket ferry</p>
              </div>
            </div>
            <div>
              <Link
              ...
              <div>
                ...
                <div className="relative rounded-md shadow-sm">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`block w-full pl-10 pr-3 py-2.5 sm:text-sm border ${
                      errors.vehicle_type ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                    } rounded-lg transition-all`}
                  >
              ...
              <div>
                ...
                <div className="relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`block w-full pl-10 pr-3 py-2.5 sm:text-sm border ${
                      errors.base_price ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                    } rounded-lg transition-all`}
...
export default VehicleCategoriesCreate;