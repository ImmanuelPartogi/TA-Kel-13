...
const MonthlyReport = () => {
  ...
  // Jika operator tidak memiliki rute (sama seperti DailyReport)
  if (!hasRoutes()) {
    return (
      <div className="container mx-auto px-4 py-6">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-6">
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Laporan Bulanan</h1>
        ...
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-2">
              ...
              {/* Hanya tampilkan tombol Export jika ada data */}
              {routeData.length > 0 && (
                <button
