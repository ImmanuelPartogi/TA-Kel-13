    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'errors' => ['error' => ['Terjadi kesalahan saat membuat booking: ' . $e->getMessage()]]
            ], 500);
        }
    }
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'errors' => ['error' => ['Terjadi kesalahan saat mengubah status booking: ' . $e->getMessage()]]
            ], 500);
        }
    }
    ...
    public function processReschedule(Request $request, $id)
    {
        ...
        try {
            ...
            return response()->json([
                ...
                'errors' => ['error' => ['Terjadi kesalahan saat reschedule: ' . $e->getMessage()]]
            ], 500);
        }
    }
}
