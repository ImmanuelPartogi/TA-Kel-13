...
class ReportController extends Controller
{
    ...
    // Tambahkan method untuk ekspor report dalam format JSON
    public function exportBookingReport(Request $request)
    {
        ...
        // Gunakan logika yang sama dengan bookingReport
        $timezone = config('app.timezone', 'Asia/Jakarta');
        $startDate = Carbon::parse($request->start_date, $timezone)->startOfDay();
        $endDate = Carbon::parse($request->end_date, $timezone)->endOfDay();
    ...
    public function exportRevenueReport(Request $request)
    {
        ...
        // Gunakan logika yang sama dengan revenueReport
        $timezone = config('app.timezone', 'Asia/Jakarta');
        $startDate = Carbon::parse($request->start_date, $timezone)->startOfDay();
        $endDate = Carbon::parse($request->end_date, $timezone)->endOfDay();
    ...
    public function exportScheduleReport(Request $request)
    {
        ...
        // Gunakan logika dari scheduleReport
        $timezone = config('app.timezone', 'Asia/Jakarta');
        $startDate = Carbon::parse($request->start_date, $timezone);
        $endDate = Carbon::parse($request->end_date, $timezone);
