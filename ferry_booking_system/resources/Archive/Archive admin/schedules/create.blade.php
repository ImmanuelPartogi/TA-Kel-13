                ...
                <form action="{{ route('admin.schedules.store') }}" method="POST" novalidate class="space-y-6"
                    ...
                    <div class="basic-info-section bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="time"
                                        ...
                                        id="arrival_time" name="arrival_time" value="{{ old('arrival_time') }}"
                                        required>
                                </div>
                                @error('arrival_time')
                            ...
                            <div id="reasonContainer" class="hidden">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text"
                                        ...
                                        id="status_reason" name="status_reason" value="{{ old('status_reason') }}"
                        ...
                        <div id="expiryDateContainer" class="mt-6 hidden">
                            ...
                            <p class="mt-1 text-xs text-gray-500">Isi jika status akan berakhir pada waktu tertentu. Khusus
                                untuk status Ditunda (DELAYED).</p>
                        </div>
                    </div>

                    <!-- Operating Days Section -->
                    <div id="operatingDaysSection"
                        class="operating-days-section bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm"
                        style="display:none;">
                        <h2 class="text-lg font-semibold mb-4 text-gray-800 flex items-center border-b pb-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                @enderror
                                <p class="text-xs text-gray-500 mt-2">Jadwal ini akan beroperasi setiap hari yang dipilih
                                </p>
                            </div>
                        </div>
            ...
            if (form) {
                ...
                document.querySelectorAll('input[name="days[]"]').forEach(checkbox => {
                    checkbox.addEventListener('change', function() {
                        try {
                            if (document.querySelectorAll('input[name="days[]"]:checked').length >
                                0) {
